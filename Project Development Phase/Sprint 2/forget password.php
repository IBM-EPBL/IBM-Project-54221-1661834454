...
if (isset($_POST['submit'])) {
 ...
 $mail->Username = 'smartroadsafety247@gmail.com'; //SMTP username
...
`SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
 ...
 $mail->Subject = 'smartroadsafety247 reset password';
 $mail->Body = 'reset link <b><a href="http://localhost/login/changepassword.php?reset='.$code.'">http://localhost/login/changepassword.php?reset='.$code.'</a></b>';
 $mail->send();
